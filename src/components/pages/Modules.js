...
import logo1 from '../images/cac-plani.jpg'
import logo2 from '../images/cac-plani-1.jpg'
import logo3 from '../images/cac-plani-3.jpg'
import logo4 from '../images/cac-plani-4.jpg'
import logo6 from '../images/cac-plani-5.jpg'
import logo5 from '../images/ca-plani-6.jpg'
import AOS from 'aos';
                    ...
                    <div class="card ">
                        <img style={style} src={logo1} class="card-img-top" alt="..."/>
                            <div class="card-body ">
                                ...
                                <Link to="/contact"><button className='btn btn-dark shadow w-100  '> Apply now</button></Link>
                    </div>
                </div></div>
